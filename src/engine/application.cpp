...
ChunkField* terrain;		// chunk field grid

// game object properties
glm::vec4 lightColor;	// World light color
glm::vec3 lightPos;		// World light position
...
Application::Application(GLFWwindow* window) {
	...
	//lightShader = new Shader(lightVertexShaderPath.c_str(), lightFragmentShaderPath.c_str());
	...
	// object models
	lightColor = glm::vec4(1.0f, 1.0f, 1.0f, 1.0f);	// light
	...
	// Camera object
	camera = new Camera(winW, winH, glm::vec3(0.0f, 0.0f, 2.0f));
}
